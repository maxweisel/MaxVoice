...
enum Google_Api_FieldBehavior: SwiftProtobuf.Enum, Swift.CaseIterable {
  ...
  static let allCases: [Google_Api_FieldBehavior] = [
    .unspecified,
    .optional,
    .required,
    .outputOnly,
...
///     [(google.api.field_behavior) = OUTPUT_ONLY,
///      (google.api.field_behavior) = IMMUTABLE];
let Google_Api_Extensions_field_behavior = SwiftProtobuf.MessageExtension<SwiftProtobuf.RepeatedEnumExtensionField<Google_Api_FieldBehavior>, SwiftProtobuf.Google_Protobuf_FieldOptions>(
...
extension Google_Api_FieldBehavior: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0FIELD_BEHAVIOR_UNSPECIFIED\0\u{1}OPTIONAL\0\u{1}REQUIRED\0\u{1}OUTPUT_ONLY\0\u{1}INPUT_ONLY\0\u{1}IMMUTABLE\0\u{1}UNORDERED_LIST\0\u{1}NON_EMPTY_DEFAULT\0\u{1}IDENTIFIER\0")
}

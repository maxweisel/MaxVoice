...
///       pattern: "organizations/{organization}/logs/{log}"
///       pattern: "billingAccounts/{billing_account}/logs/{log}"
struct Google_Api_ResourceDescriptor: Sendable {
  ...
  ///       };
  ///     }
  var history: Google_Api_ResourceDescriptor.History = .unspecified
  ...
  var style: [Google_Api_ResourceDescriptor.Style] = []

  var unknownFields = SwiftProtobuf.UnknownStorage()

  /// A description of the historical or future-looking state of the
  /// resource pattern.
  enum History: SwiftProtobuf.Enum, Swift.CaseIterable {
    ...
    static let allCases: [Google_Api_ResourceDescriptor.History] = [
      .unspecified,
  ...
  enum Style: SwiftProtobuf.Enum, Swift.CaseIterable {
    ...
    // The compiler won't synthesize support with the UNRECOGNIZED case.
    static let allCases: [Google_Api_ResourceDescriptor.Style] = [
      .unspecified,
      .declarativeFriendly,
    ]
...
/// an API resource.
struct Google_Api_ResourceReference: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
let Google_Api_Resource_Extensions: SwiftProtobuf.SimpleExtensionMap = [
...
extension Google_Api_ResourceDescriptor: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}type\0\u{1}pattern\0\u{3}name_field\0\u{1}history\0\u{1}plural\0\u{1}singular\0\u{2}\u{4}style\0")
  ...
  static func ==(lhs: Google_Api_ResourceDescriptor, rhs: Google_Api_ResourceDescriptor) -> Bool {
...
extension Google_Api_ResourceDescriptor.History: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0HISTORY_UNSPECIFIED\0\u{1}ORIGINALLY_SINGLE_PATTERN\0\u{1}FUTURE_MULTI_PATTERN\0")
}

extension Google_Api_ResourceDescriptor.Style: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0STYLE_UNSPECIFIED\0\u{1}DECLARATIVE_FRIENDLY\0")
}
...
extension Google_Api_ResourceReference: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".ResourceReference"
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}type\0\u{3}child_type\0")
  ...
  static func ==(lhs: Google_Api_ResourceReference, rhs: Google_Api_ResourceReference) -> Bool {
    if lhs.type != rhs.type {return false}
